...
Προσέξτε ότι αναλόγως από το πού ξεκινάμε να διατρέχουμε το μονοπάτι η ακολουθία μπορεί να εμφανίζεται ότι αρχίζει και ξεκινάει αλλού. Για παράδειγμα, αν ξεκινήσουμε να διατρέχουμε τον κύκλο Euler από τον κόμβο TG θα προκύψει η ακολουθία TGGCAATGCG. Στην ουσία δηλαδή η ακολουθία είναι κυκλική. Δείτε στη συνέχεια στην περιγραφή εξόδου με ποιον τρόπο θα πρέπει να την εμφανίζετε ώστε η έξοδος του προγράμματος να είναι μονοσήμαντη.
